package com.tgliedt.controllerandview.models;
...
public class Country {
	...
	public Country(int id, String code, String name, String continent, String region, float surface_area,
			int indep_year, int population, float life_expectancy, float gnp, float gnp_old, String local_name,
			String government_form, String head_of_state, int capital, String code2, List<Language> languages,
			List<City> cities) {
		this.id = id;
		this.code = code;
		this.name = name;
