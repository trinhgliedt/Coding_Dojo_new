...
function greaterOfTwoQueues(queue1, queue2) {
    // if (queueSum(queue1) > queueSum(queue2)) {
    //     return queue1;
    // }
    // else {
    //     return queue2;
    // }
    return (queueSum(queue1) > queueSum(queue2)) ? queue1 : queue2;
}
...
function queueSum(queue) {
    ...
    while (!queue.isEmpty()) {
        ...
        sum += dequeuedNode.data;
        newQueue.enqueue(dequeuedNode);
    }
