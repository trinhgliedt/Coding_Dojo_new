...
class minStack {
    ...
    var min = this.top;
pop
Compr to min value if < store
    push to newstack
% till null
then rebuild orig stack
...
//check if empty
//if nots then pop out first value into the newstack
//pop out value from stack and compare to previous pop, stored at min var,
//if less then we push to the second stack and add to the array,
//else we only push into the second stack and continue process until completed
