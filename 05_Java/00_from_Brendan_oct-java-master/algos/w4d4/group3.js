...
class BST {
    ...
    delete(val, current) {
        ...
        // Check if root is node to delete
        if (this.root.val == val) {
            var deletedNode = this.root;
            ...
            if (this.root.left != null &&
                this.root.right != null) {
                var smallestRight = removeSmallest(this.root.right);
                smallestRight.left = this.root.left;
                smallestRight.right = (this.root.right == smallestRight) ? null : this.root.right;
                this.root = smallestRight;
            }
            return deletedNode;
        }
        // Check if left node isthe one to delete
        if (current.left.val === val) {
            var deletedNode = current.left;
            ...
            if (current.left.left != null &&
                current.left.right != null) {
                var smallestRight = removeSmallest(current.left.right);
                smallestRight.left = current.left.left;
                smallestRight.right = (smallestRight == current.left.right) ? null : current.left.right;
                current.left = smallestRight;
            }
            return deletedNode;
        }
        // Check if right node isthe one to delete
        if (current.right.val === val) {
            var deletedNode = current.right;
            ...
            if (current.right.left != null &&
                current.right.right != null) {
                var smallestRight = removeSmallest(current.right.right);
                smallestRight.left = current.right.left;
                smallestRight.right = (smallestRight == current.right.right) ? null : current.right.right;
        ...
        return this.delete(val, current);
    }
