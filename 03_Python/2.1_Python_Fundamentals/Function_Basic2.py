...
def printAndReturn(n1, n2):
    print(n1)
    return n2
print(printAndReturn(3, 9))
...
print(firstPlusLength([5,3,4,3,2,6]))

# 4 Values Greater than Second - Write a function that accepts a list and creates 
# a new list containing only the values from the original list that are greater than its 2nd value. 
...
def greaterThanSecond(list):
    ...
    print(len(newList))
    return newList
print(greaterThanSecond([2,3,6,4,1,9,8]))
print(greaterThanSecond([8,7,6-2,3,4]))
print(greaterThanSecond([8,7]))
print(greaterThanSecond([8]))

# 5 This Length, That Value - Write a function that accepts two integers as parameters: 
# size and value. The function should create and return a list whose length is equal to 
...
print(thisLengthThatValue (0,50))
print(thisLengthThatValue (-2,7))